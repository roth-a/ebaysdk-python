...
if __name__ == "__main__":
    ...
    print(
        "To JSON %s"
        % timeit.repeat(
            "tojson()", number=1000, repeat=9, setup="from __main__ import tojson"
        )
    )
    ...
    print(
        "To uJSON %s"
        % timeit.repeat(
            "toujson()", number=1000, repeat=9, setup="from __main__ import toujson"
        )
    )
    ...
    print(
        "dict2xml() %s"
        % timeit.repeat(
            "main()", number=1000, repeat=9, setup="from __main__ import main"
        )
    )
    ...
    print(
        "Response Class %s"
        % timeit.repeat(
            "response()", number=1000, repeat=9, setup="from __main__ import response"
        )
    )
