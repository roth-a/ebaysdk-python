...
dict2 = {"tag": {"#text": 222, "@attrs": {"site": "US", "attr2": "attr2value"}}}
...
assert (
    dict2xml(dict3)
    == "<itemFilter><name>Condition</name><value>Used</value></itemFilter><itemFilter><name>LocatedIn</name><value>GB</value></itemFilter><itemFilter><name>More</name><value>more</value></itemFilter>"
)
...
dict5 = {
    "tag1": {
        "#text": {"tag2": {"#text": "tag2 value", "@attrs": {"tag2attr": "myvalue"}}},
